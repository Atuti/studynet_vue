                    ...
                    <div class="column is-10">
                        <template v-if="this.$store.state.user.isAuthenticated">
                            ...
                            <template v-if="activeLesson">
                                ...
                                <span class="tag is-success" v-if="activity.status == 'done '" @click="markAsUndone">Done (mark as undone)</span>
                                <span class="tag is-danger" v-if="activity.status == 'undone'" @click="markAsDone">Undone</span>
...
export default{
    ...
    methods: {
        ...
        markAsUndone(){
            ...
            axios
                .post(`activities/mark_as_undone/${this.$route.params.slug}/${this.activeLesson.slug}/`)
                .then(response => {
                    console.log(response.data)
...
<!-- To correct the display of questions.... -->